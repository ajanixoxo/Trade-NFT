...
function News() {
  return (
    ...
    <div className="bg-[#0D0519] p-4 py-8 flex flex-col items-center justify-center"
    >
        <div className="flex flex-col items-center justify-center gap-10 w-full md:w-1/2 rounded-md bg-[#251e30] p-4">
            <div  className="flex flex-col items-center justify-center gap-5">
                <h1 className="h1 text-[25px] md:text-[32px] font-semibold text-white ">Stay in the loop</h1>
                <p className="text-white text-[15px] font-light text-center">
                Get the latest NFT updates and exclusive offers straight to your inbox!
                </p>
            </div>
            <div className=" w-1/2  flex flex-col items-center justify-center md:flex-row gap-5">
                <div className=" bg-[#392243] p-2 lg:p-4 lg:w-[50%] " >
                <input type="email" placeholder="Enter Email Address" className="border-none bg-transparent mb-2" />
                </div>
                <span>
    ...
    <img src={line} alt="" />
    <footer className="bg-[#0D0519]">
        <p className="text-white p-2 text-[15px] text-center">
        © Designed by <a href="https://x.com/Crownzdesigns" className="text-[#815EE3]">Crownz Web.3</a>  developed my <a href="https://x.com/Dexcoded01" className="text-[#815EE3]">Adeoluwa</a> 
        </p>
    </footer>
    </div>
  )
